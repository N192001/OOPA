...
import com.example.spleshanimataiontest.utils.CreateInvoice;
...
public class Detail_complete  extends AppCompatActivity {
...
//        txtdelivery = findViewById(R.id.txt_delivery);
        ...
        try {
           ...
           /* if (order.matches("new")) {
                setTitle("New Order : " + myList.get(position).getBooking_id());
            ...
            if (order.matches("complete")) {
                setTitle("Completed Order : " + myList.get(position).getBooking_id());
                txt_order_status.setText("Order Status : Complete Order");
                txtprocess.setText("Order Complete ");
                rl_location.setVisibility(View.GONE);
...
if (myListsave!=null) {
    ...
    rl_location.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            orderid=myListsave.get(position).getBooking_id();
    ...
    rl_print.setOnClickListener(new View.OnClickListener() {
        ...
        /*txtdelivery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Toast.makeText(getApplicationContext(),"calling status ",Toast.LENGTH_LONG).show();
                    if (order.matches("new")) {
                        setStstus( orderid,  shopid,  statusid,  updateat);
                    } else if (order.matches("ongoing")) {
                        setStstus( orderid,  shopid,  statusid,  updateat);
                    ...
                    Log.e("tag","Problem in changing order status  : "+e.getMessage());
                }
            }
        });*/
